...
def defuzzifikasi(kelayakan_rendah, kelayakan_sedang, kelayakan_tinggi):
    ...
    max_output_values = [domain_val for domain_val in domain if
                           (domain_val in output_rendah and keanggotaan_rendah == max_keanggotaan) or
                           (domain_val in output_sedang and keanggotaan_sedang == max_keanggotaan) or
                           (domain_val in output_tinggi and keanggotaan_tinggi == max_keanggotaan)]
